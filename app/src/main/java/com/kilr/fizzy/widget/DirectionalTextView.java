...
public class DirectionalTextView extends FrameLayout
{
    ...
    protected void onFinishInflate() {
        ...
        mMainText = (TextView) findViewById(R.id.dtv_main_text);
        mMarkerText = (TextView) findViewById(R.id.dtv_marker_view);
        mDistanceText = (TextView) findViewById(R.id.dtv_distance_text);
